...
export const instructorProfiles: InstructorProfile[] = [
  {
    ...satoBase,
    slug: "sato-ryoko",
    focusAreas: ["キャリア・職場の相談に基づいた研修設計", "心理的专业性を踏まえたメンタルヘルス・ハラスメント関連研修", "EAPの現場を踏まえた実務的なファシリテーション"],
  ...
  },
  {
    ...tatenoBase,
    slug: "tateno-rika",
    focusAreas: ["接客・対人支援の現場に即したコミュニケーション研修", "マナー・印象づくりを含む職場の振る舞い設計", "キャリアや生活設計にも踏み込んだ伴走型のファシリテーション"],
